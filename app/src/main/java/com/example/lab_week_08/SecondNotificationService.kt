...
class SecondNotificationService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        // buat & tampilkan notifikasi foreground
    ...
    private fun getNotificationBuilder(pendingIntent: PendingIntent, channelId: String) =
        NotificationCompat.Builder(this, channelId)
            ...
            .setContentText("Almost finished!")
            .setSmallIcon(R.drawable.ic_launcher_foreground)
            .setContentIntent(pendingIntent)
            .setTicker("Third worker process is done, almost finished!")
            .setOngoing(true)
    ...
    private fun countDownFromFiveToZero(builder: NotificationCompat.Builder) {
        ...
        for (i in 5 downTo 0) {
            Thread.sleep(1000L)
            builder.setContentText("$i seconds until done").setSilent(true)
    ...
    companion object {
        const val NOTIFICATION_ID = 0xBABE
